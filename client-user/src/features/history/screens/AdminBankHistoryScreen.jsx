...
import { History, Loader2, AlertCircle, BarChart3, RefreshCw, ChevronRight, Wallet, PiggyBank } from 'lucide-react-native';
          ...
          <View style={styles.accountGrid}>
            <View style={styles.accountsList}>
              <View style={styles.accountsListHeader}>
                <Text style={styles.accountsListTitle}>{filteredAccounts.length} cuenta{filteredAccounts.length !== 1 ? 's' : ''}</Text>
              </View>
