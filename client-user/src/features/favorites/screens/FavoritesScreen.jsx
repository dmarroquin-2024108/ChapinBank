...
const FavoritesScreen = ({ rightAction }) => {
  ...
  return (
    <View style={styles.screenContainer}>
      <Header title="Favoritos" rightAction={rightAction} />
...
const styles = StyleSheet.create({
  ...
  favoriteItem: { flexDirection: 'row', alignItems: 'center', gap: SPACING.sm, backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.border, borderRadius: 12, padding: SPACING.sm, marginBottom: SPACING.xs },
  ...
  dateText: { fontSize: 12, color: COLORS.textSecondary, marginLeft: SPACING.sm },
  actionsContainer: { flexDirection: 'row', gap: 4, marginLeft: SPACING.sm },
  actionButton: { width: 28, height: 28, borderRadius: 8, borderWidth: 1, borderColor: COLORS.border, justifyContent: 'center', alignItems: 'center' },
});
