...
const styles = StyleSheet.create({
  ...
  modalContent: { backgroundColor: COLORS.surface, borderRadius: 16, width: '100%', maxWidth: 400, maxHeight: '90%', ...SHADOWS.large, overflow: 'hidden' },
  ...
  modalBody: { paddingTop: 36, paddingHorizontal: SPACING.lg, paddingBottom: SPACING.lg },
