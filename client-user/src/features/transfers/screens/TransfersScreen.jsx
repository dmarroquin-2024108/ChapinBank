      ...
      <View style={styles.buttonContainer}>
        {canCancel && (
          <TouchableOpacity onPress={() => onCancel(transfer.transferToken)} disabled={cancelLoading} style={[styles.cancelButton, cancelLoading && styles.buttonDisabled]}>
            ...
            <Text style={styles.cancelButtonText}>{cancelLoading ? 'Cancelando…' : 'Cancelar transferencia'}</Text>
          </TouchableOpacity>
        )}
...
const TransfersScreen = ({ navigation, rightAction }) => {
  ...
  return (
    <View style={styles.screenContainer}>
      <Header title="Transferencias" rightAction={rightAction} />
                  ...
                  <View style={styles.favoritesList}>
                    {favorites.map((fav) => (
                      ...
                      >
                        ...
                        <TouchableOpacity onPress={() => handleDeleteFavorite(fav._id)} style={styles.deleteButton}>
              ...
              <>
                ...
                <View style={styles.buttonContainer}>
                  <TouchableOpacity onPress={() => { setAmount(''); setDescription(''); setNumberAccountDestination(''); setDestinationHolder(''); }} style={styles.cancelButton}>
                    <Text style={styles.cancelButtonText}>Cancelar movimiento</Text>
                  </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  selectedFavoriteAlias: { fontSize: 12, fontWeight: 'bold', color: COLORS.primaryDark },
