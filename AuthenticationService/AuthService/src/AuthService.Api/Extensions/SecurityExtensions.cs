...
public static class SecurityExtensions
{
    ...
    private static readonly string[] AllowedHttpMethods = ["GET", "POST", "PUT", "DELETE", "OPTIONS", "PATCH"];
    ...
    {
        // configurar el CORS. Permite identificar o manipular quien puede puede decir info al Api
        ...
        var dataProtectionBuilder = services.AddDataProtection()
                ...
                .SetApplicationName("AuthChapinBankApi")
