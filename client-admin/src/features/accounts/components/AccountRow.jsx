    ...
    return (
        <tr className='border-b border-gray-50 hover:bg-gray-50/60 transition-colors'>
            ...
            <td className='py-4 px-6 whitespace-nowrap'>
                ...
                <p className='text-xs text-gray-400'>{account.ownerUsername ? `@${account.ownerUsername}` : ''}</p>
            </td>

            <td className='py-4 px-6 whitespace-nowrap'>
                <span className={`inline-flex items-center gap-1.5 text-xs font-medium px-2.5 py-0.5 rounded-full ${typeConfig.className}`}>
                    <Icon size={11} />
                    {typeConfig.label}
                </span>
            </td>
            ...
            <td className='py-4 px-6 whitespace-nowrap'>
                <span
                    className={`inline-flex items-center gap-1 text-xs font-medium px-2.5 py-0.5 rounded-full ${isActive ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-500'
                        }`}
                >
            ...
            <td className='py-4 px-6 whitespace-nowrap'>
                <div className='flex items-center justify-end gap-1'>
                    ...
                    <button
                        ...
                        className={`p-1.5 rounded-lg transition cursor-pointer ${isActive
