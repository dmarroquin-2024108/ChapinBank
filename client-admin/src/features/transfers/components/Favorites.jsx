                ...
                <div className="space-y-2">
                    {favorites.map(fav => (
                        <button
                            ...
                            className={`w-full flex items-center gap-3 p-3.5 rounded-xl border text-left transition-all duration-150 ${selectedFavorite?._id === fav._id
                                    ? 'border-orange bg-orange/5 shadow-sm ring-1 ring-orange/20'
                                    : 'border-gray-100 bg-white hover:border-gray-200 hover:shadow-sm'
                                }`}
                        >
                            <div className={`w-10 h-10 rounded-full flex items-center justify-center text-white text-sm font-bold shrink-0 ${avatarColor(fav.alias)}`}>
                            ...
                            <div className="flex-1 min-w-0 text-left">
                                ...
                                <p className="text-xs text-gray-300 font-mono mt-0.5">•••• {fav.accountNumber.slice(-4)}</p>
                            </div>
                            ...
                            <div
                                ...
                                onKeyDown={(e) => { if (e.key === 'Enter') handleDelete(e, fav._id); }}
