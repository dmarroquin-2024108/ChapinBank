...
export const ProfileModal = ({ isOpen, onClose, userBase }) => {
    ...
    const initials = `${userBase?.name?.[0] ?? ""}${userBase?.surname?.[0] ?? ""}`.toUpperCase() || "U";
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input
                                ...
                                {...register("username", { minLength: { value: 5, message: "Mínimo 5 caracteres" } })}
                            />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                {...register("nameWork", { minLength: { value: 5, message: "Mínimo 5 caracteres" } })}
                            />
                            {errors.nameWork && <p className="text-red-500 text-xs mt-0.5">{errors.nameWork.message}</p>}
                        </div>
                        ...
                        <div>
                            ...
                            />
                            {errors.ingresosMensuales && <p className="text-red-500 text-xs mt-0.5">{errors.ingresosMensuales.message}</p>}
                        </div>
                    </div>
