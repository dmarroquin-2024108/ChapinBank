...
const QUICK_ACTIONS = [
    ...
    { label: "Transferencias", sub: "Envía dinero", icon: ArrowLeftRight, to: "/" },
...
export const UserPage = () => {
    ...
    const fmt = (n) => new Intl.NumberFormat('es-GT', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(n);
