import { createTransferRecord, acceptTransferRecord, cancelTransferRecord,rejectTransferRecord, getDailyLimitStatus } from "./transfer.service.js";
import { getAllRates } from "../../helpers/currency.helper.js";

export const createTransfer = async (req, res) => {
    try {
        const { transfer, nuevoBalanceOrigen, commision, amountInGTQ, exchangeRate, transferToken, cancelWindowMinutes} = await createTransferRecord({
