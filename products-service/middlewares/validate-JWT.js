...
export const validateJWT = (req, res, next) => {
    ...
    try {
        ...
        req.user = {
            ...
            role: decoded["http://schemas.microsoft.com/ws/2008/06/identity/claims/role"] || decoded.role || 'USER_ROLE', // Rol del usuario (default: USER_ROLE)
            ...
            accountType: decoded.accountType || 'MONETARIA'//Monetaria > MONETARIA
        };
